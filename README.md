...
Mean depths were visualized in the project Rmd [pacific_herring_summary_202509.Rmd](https://github.com/letimm/pacific-herring_lcWGS/blob/main/RMarkdown_htmls/pacific_herring_summary_202509.Rmd). No individuals fell below the mean depth threshold of 1x, so all samples were included in genotype likelihood calculation.
...
Mean depths for mitogenomic alignments were visualized in [pacific-herring_mt-genome_202509.Rmd](https://github.com/letimm/pacific-herring_lcWGS/blob/main/RMarkdown_htmls/pacific-herring_mt-genome_202509.Rmd). No individuals were excluded from genotype likelihood calculation due to low coverage across the mitogenome.
...
Mitogenomic data were analyzed with several R packages. These are detailed in [pacific-herring_mt-genome_202509.Rmd](https://github.com/letimm/pacific-herring_lcWGS/blob/main/RMarkdown_htmls/pacific-herring_mt-genome_202509.Rmd).
...
#### Genomic outlier / region of interest analysis
For each pairwise comparison (e.g., Cordova vs Popof Island; Togiak vs Constantine Bay; eBSAI lineage A vs lineage B, etc), genomic regions of interest were defined by the intersection between sites in the top 1% of _FST_ values (differentiating) and those identified by local score analysis (under selection). Intersecitons were identified with [fst-local_score_202509.Rmd](https://github.com/letimm/pacific-herring_lcWGS/blob/main/scripts/fst-local_score_202509.Rmd).
...
Linkage disequilibrium between all pairs of SNPs within this outlier region was calculated with ngsLD, as detailed in [CPAL-CHARFULL-eBS-AC_chr7region_linkage.sh](https://github.com/letimm/pacific-herring_lcWGS/blob/main/scripts/CPAL-CHARFULL-eBS-AC_chr7region_linkage.sh).
