...
angsd -b /center1/GLASSLAB/letimm/Clupea_pallasii/CPAL-CHAR_filtered_bamslist.txt -ref /center1/GLASSLAB/letimm/ref_genomes/GCF_900700415.2_Ch_v2.0.2_genomic.fna -r ${contig}: -out /center1/GLASSLAB/letimm/Clupea_pallasii/gls/CPAL-CHAR_${contig}_polymorphic -nThreads 10 -uniqueOnly 1 -remove_bads 1 -trim 0 -C 50 -minMapQ 15 -minQ 15 -doCounts 1 -setminDepth 40 -setmaxDepth 200.0 -doGlf 2 -GL 1 -doMaf 1 -doMajorMinor 1 -minMaf 0.05 -SNP_pval 1e-10 -doDepth 1 -dumpCounts 3 -only_proper_pairs 1
