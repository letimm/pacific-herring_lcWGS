...
BASEDIR <- "C:/Users/laura.timm/Desktop/Clupea_pallasii/local_score/"

#2pop scenario; don't run unless you really want to...
#comp_title <- "2pop"
#pop1_id <- "eBSAI"
#pop2_id <- "nGOA"
#FET_filename <- paste0(BASEDIR, comp_title, "_", pop1_id, "-", pop2_id, "_localscore_input.txt")

#3pop scenario - DONE (not eBSAI, too noisy)
#comp_title <- "3pop"
#pop1_id <- "eBSAI"
#pop2_id <- "nGOA"
#pop3_id <- "PI"
...
Time to detect genomic outliers in a sequence of correlated scores (from Fariello et al 2017)!

## Read in data
```{r read_in_dataframe}
#chromosome number | position | score
#The first line of the table should include the names: chr pos pval
fet_df <- fread(FET_filename, head=T) # if rerunning from fet_df output
setkey(fet_df, chr)
...
pname= paste0(BASEDIR,"/plots/",comp_title, "_", pop1_id, "-", pop2_id,"_pvaldist.pdf")
pdf(pname)
qplot(pval, data=fet_df, geom='histogram', binwidth=0.1, main='P-values histogram')
invisible(dev.off())

bname= paste0(BASEDIR,"/plots/",comp_title, "_", pop1_id, "-", pop2_id,"_blog10.pdf")
pdf(bname)
...
KST=ks.test(unique(fet_df$pval), "punif",minP,maxP)
if (KST$p.value < 0.05) {
  print("P-values do not appear to follow a uniform distribution. Continue as normal.")
} else {
  print("P-VALUES APPEAR TO FOLLOW A UNIFORM DISTRIBUTION.")
}
...
filename <- paste0(BASEDIR,"/output/", comp_title, "_", pop1_id, "-", pop2_id,"_tuning_parameter_xi_percentiles.txt")
...
sig05name = paste0(BASEDIR,"/output/",comp_title, "_", pop1_id, "-", pop2_id,"_xi",xi, "_05sig.txt")
sig01name = paste0(BASEDIR,"/output/",comp_title, "_", pop1_id, "-", pop2_id,"_xi",xi, "_01sig.txt")
sig001name = paste0(BASEDIR,"/output/",comp_title, "_", pop1_id, "-", pop2_id,"_xi",xi, "_001sig.txt")
sig075name = paste0(BASEDIR,"/output/",comp_title, "_", pop1_id, "-", pop2_id,"_xi",xi, "_075sig.txt")
...
avname = paste0(BASEDIR,"/output/",comp_title, "_", pop1_id, "-", pop2_id,"_xi",xi, "_mean_sig.txt")
...
chrname = paste0(BASEDIR,"/output/",comp_title, "_", pop1_id, "-", pop2_id,"_xi",xi,"_chr_sig.txt")
...
lsname = paste0(BASEDIR,"/output/",comp_title, "_", pop1_id, "-", pop2_id,"_xi",xi, ".ls")
...
# Plotting chr-by-chr
pdf(paste0(BASEDIR,"/plots/",comp_title, "_", pop1_id, "-", pop2_id,'_ScoreLocalAll_xi',xi,'_nonuniform.pdf'))
