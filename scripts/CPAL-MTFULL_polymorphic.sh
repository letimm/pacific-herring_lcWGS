...
#SBATCH --output=/center1/GLASSLAB/letimm/Clupea_pallasiiFULL/job_outfiles/CPAL-MTFULL_polymorphic_%A.out
...
angsd \
	...
	-r NC_009578.1: \
	-out /center1/GLASSLAB/letimm/Clupea_pallasiiFULL/gls/CPAL-MTFULL_NC_009578.1_polymorphic \
	-nThreads 10 \
	-uniqueOnly 1 \
	-remove_bads 1 \
	-trim 0 \
