...
#SBATCH --ntasks=24
#SBATCH --mem=214G
#SBATCH --job-name=fgls
#SBATCH --output=/center1/GLASSLAB/letimm/Clupea_pallasiiFULL/job_outfiles/CPAL-CHARFULL_filteredGLS_%A-%a.out
...
angsd \
	-b /center1/GLASSLAB/letimm/Clupea_pallasiiFULL/CPAL-CHARFULL_filtered_bamslist.txt \
	...
	-r ${contig}: \
	-out /center1/GLASSLAB/letimm/Clupea_pallasiiFULL/gls/CPAL-CHARFULL_${contig}_polymorphic-filtered \
	-nThreads 10 \
	-uniqueOnly 1 \
	-remove_bads 1 \
	-trim 0 \
