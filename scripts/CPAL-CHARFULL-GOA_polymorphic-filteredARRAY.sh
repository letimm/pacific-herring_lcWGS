...
#SBATCH --ntasks=24
#SBATCH --mem=214G
#SBATCH --job-name=plm-GOA
#SBATCH --output=/center1/GLASSLAB/letimm/Clupea_pallasii120/job_outfiles/CPAL-CHARFULL-GOA_polymorphic-filtered_%A-%a.out
...
angsd \
	-b /center1/GLASSLAB/letimm/Clupea_pallasii120/CPAL-CHARFULL-GOA_filtered_bamslist.txt \
	...
	-r ${contig}: \
	-out /center1/GLASSLAB/letimm/Clupea_pallasii120/gls/CPAL-CHARFULL-GOA_${contig}_polymorphic-filtered \
